...
urlpatterns = [
    ...
    path('divorce/<int:pk>', views.EvenementUpdateView.as_view(model=models.Divorce), name='divorce'),
    path('divorce/<int:pk>/create', views.EvenementCreateView.as_view(model=models.Divorce), name='add-divorce'),
    path('divorce/<int:pk>/delete', views.EvenementDeleteView.as_view(model=models.Divorce), name='del-divorce'),
